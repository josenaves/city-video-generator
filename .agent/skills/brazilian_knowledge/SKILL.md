...
* Microregion and Mesoregion
* A brief description of the city
* A list of neighboring cities
* Altitude
...
```json
{
    ...
    "estado": "MG",
    "populacao": 52234,
    "data_fundacao": "01/06/1912",
    "coordenadas": {
        "latitude": -21.305,
        "longitude": -46.71278
    },
    "microrregiao": "São Sebastião do Paraíso",
    "mesorregiao": "Sul/sudoeste de Minas",
    "descricao": "Guaxupé é uma cidade no sul de Minas Gerais, conhecida como a "Capital do Café". A economia local está fortemente ligada à produção cafeeira, além de outros produtos agrícolas. A cidade também se destaca pela cultura mineira, festas tradicionais e belezas naturais.",
    "vizinhos": [
        {
            "nome": "Mococa",
            "estado": "SP",
...
**Decision:** The data is stored in a comprehensive JSON file, which is generated by a script that processes local data from the `cidades-brasileiras` project. This approach ensures that the data is consistent and can be easily updated by running the build script.
